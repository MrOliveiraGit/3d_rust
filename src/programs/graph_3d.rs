...
impl Graph3D {
    pub fn new(gl:&WebGlRenderingContext)-> Self {
        ...
        let positions_and_indices = cf::get_position_grad_n_by_n(super::super::constants::GRID_SIZE);
